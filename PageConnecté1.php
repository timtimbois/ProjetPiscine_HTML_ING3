				...
				<div class="rowA">
					...
					<div class="col-lg-6">
						...
						<div class="card shadow mb-4">
							...
							<div class="card-body">
								<p>Bienvenue sur votre compte ! Je vous laisse profiter du site. Bonnes ventes à vous VENDEUR</p>

								<?php 
										echo $_SESSION['NomVendeur'];
										echo var_dump($_SESSION['IDVendeur']);
								 ?>
