...
<head>
	...
	<title>EbayECE : Ferraille ou Tresor</title>
	...
	<div class="wrapper">
		...
		<nav id="sidebar">
			...
			<ul class="list-unstyled components">
				...
				<li>
					<a href="AdminLogin.php" class = "icon-bin"> Admin</a>
				</li>
					...
					<div class="col-lg-6">
						...
						<div class="card shadow mb-4">
							<div class="card-header py-3">
								<h6 class="m-0 font-weight-bold text-primary">Voici les ferrailes et les trésors <?php echo $_SESSION['PrenomAcheteur']; ?> </h6>
							</div>
							<div class="card-body">
						...
						//Affichage des objets AcheterMaintenant
								...
								$reqselcitem = $bdd->prepare('SELECT IDItem, NomItem, Photo1Item, Photo2Item, VideoItem, DescriptionItem, PrixItem, Photo3Item, CategorieItem, TypeVenteItem FROM item WHERE CategorieItem LIKE "Ferraille ou Trésor" AND TypeVenteItem LIKE "AcheterMaintenant"');
								...
								<div id="GroupeAch"> 
									...
									while ($data = $reqselcitem->fetch()) {
										...
										echo '<form method="post" action="PageFerrailleOuTresor.php">'.
						...
						//Affichage des objets MeilleureOffre

									$reqselcitem = $bdd->prepare('SELECT IDItem, NomItem, Photo1Item, Photo2Item, VideoItem, DescriptionItem, PrixItem, Photo3Item, CategorieItem, TypeVenteItem FROM item WHERE CategorieItem LIKE "Ferraille Ou Trésor" AND TypeVenteItem LIKE "MeilleureOffre"');
						...
						//Affichage des objets Enchère

									$reqselcitem = $bdd->prepare('SELECT IDItem, NomItem, Photo1Item, Photo2Item, VideoItem, DescriptionItem, PrixItem, Photo3Item, CategorieItem, TypeVenteItem FROM item WHERE CategorieItem LIKE "Ferraille Ou Trésor" AND TypeVenteItem LIKE "Enchère"');
