...
<head>
	...
	<title>EbayECE : Chat Offre</title>
				...
				<div class="rowA">
					...
					<div class="col-lg-6">
						...
						<div class="card shadow mb-4">
							...
							<div class="card-body">
								<p>Faites des offres sur ID : <?php echo $_POST['IDItem']; ?></p>

								<header>
									<h1>Chat avec le vendeur de ce produit !</h1>
								</header>
								...
								<section class="chat">
									...
									<div class="user-inputs">
										<form action="ChatOffrePHP.php?task=write" method="POST">
											<input type="null" name="author" id="author"class = "form-control" value="<?php echo $_SESSION['PrenomAcheteur']; ?> : <?php echo $_POST['IDItem']; ?>" readonly >
											<input type="number" id="contentt" class="form-control" name="contentt" placeholder="Votre offre en € !">
											<br>
											...
											for($compt = 1; $compt<6; $compt++)
											{
												...
												<button type="submit" class="btn btn-primary" onClick = "this.style.visibility= 'hidden';"> 💬 Send Offre : <?php echo $compt; ?></button>
								...
								<script type="text/javascript">
									...
									author = "<?php echo $_SESSION['PrenomAcheteur']; ?>  <?php echo $_POST['IDItem']; ?>";

									function getMessages(){

										const requeteAjax = new XMLHttpRequest();
										requeteAjax.open("GET", "ChatOffrePHP.php");
									...
									function postMessage(event){
										...
										const requeteAjax = new XMLHttpRequest();
										requeteAjax.open('POST', 'ChatOffrePHP.php?task=write');
			...
			<div class="container-fluid">
				...
				<div class="rowA">
					...
					<div class="col-lg-6">
						...
						<div class="card shadow mb-4">
							<div class="card-header py-3">
								<h6 class="m-0 font-weight-bold text-primary"> <?php echo $_SESSION['PrenomAcheteur']; ?> Voici La Réponse Finale De Votre Offre</h6>
							</div>
							<div class="card-body">
								<p>RELOAD VOTRE PAGE POUR OBTENIR LA REPONSE FINALE, MERCI</p>
								...
								$requete = $bdd->prepare('SELECT * FROM messages WHERE contentt LIKE "OUI'.$_SESSION['PrenomAcheteur'].''.$_POST['IDItem'].'" ');
							...
							// $author = $_SESSION['PrenomAcheteur'].$_SESSION['IDItem'];
								...
								if ($data['contentt'] =="OUI".$_SESSION['PrenomAcheteur'].$_POST['IDItem']) {


								// echo "<script> alert (\"la variable est nulle\")</script";
									echo '<li> Le produit ID : '.$_POST['IDItem'].'  vous appartient. Transaction : '.$data['id'].'</li>';

									echo "Vous allez recevoir une confirmation trés vite, Merci.";


						    	// ENVOYER UN MAIL DE CONFIRMATION D'ACHAT À L'ACHETEUR
									...
									<br />
									Un achat à été effectué depuis votre compte. Le produit ID : '.$_POST['IDItem'].' vous appartient.
									<br />
									Votre commande numéro : '.$data['id'].' a bien été enregistrée.
									<br>
									<br>
						    	...
						    	// FIN ENVOIE DU MAIL
									...
									$requete1 = $bdd->prepare('DELETE FROM item WHERE IDItem="'.$_POST['IDItem'].'"');
									$requete1->execute();
