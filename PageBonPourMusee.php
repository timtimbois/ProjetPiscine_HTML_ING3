...
<head>
	...
	<title>EbayECE : Bon pour le Musée </title>
					...
					<div class="col-lg-6">
						...
						<div class="card shadow mb-4">
							<div class="card-header py-3">
								<h6 class="m-0 font-weight-bold text-primary">Voici les objets bon pour le musée <?php echo $_SESSION['PrenomAcheteur']; ?> </h6>
							</div>
							<div class="card-body">
						...
						//Affichage des objets AcheterMaintenant
								...
								$reqselcitem = $bdd->prepare('SELECT IDItem, NomItem, Photo1Item, Photo2Item, VideoItem, DescriptionItem, PrixItem, Photo3Item, CategorieItem, TypeVenteItem FROM item WHERE CategorieItem LIKE "Bon pour le musée" AND TypeVenteItem LIKE "AcheterMaintenant"');
								...
								<div id="GroupeAch"> 
									...
									while ($data = $reqselcitem->fetch()) {
										...
										echo '<form method="post" action="PageBonPourMusee.php">'.
						...
						//Affichage des objets MeilleureOffre
									...
									$reqselcitem = $bdd->prepare('SELECT IDItem, NomItem, Photo1Item, Photo2Item, VideoItem, DescriptionItem, PrixItem, Photo3Item, CategorieItem, TypeVenteItem FROM item WHERE CategorieItem LIKE "Bon pour le musée" AND TypeVenteItem LIKE "MeilleureOffre"');
						...
						//Affichage des objets Enchère
									...
									$reqselcitem = $bdd->prepare('SELECT IDItem, NomItem, Photo1Item, Photo2Item, VideoItem, DescriptionItem, PrixItem, Photo3Item, CategorieItem, TypeVenteItem FROM item WHERE CategorieItem LIKE "Bon pour le musée" AND TypeVenteItem LIKE "Enchère"');
